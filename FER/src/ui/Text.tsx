...
export const Text: FC<TextProps> = ({ text, fontSize, paddingX, paddingY, color, additionalStyles = '' }) => {
    ...
    const sStyle = [sBased, sFontSize, sPaddingX, sPaddingY, sColor, additionalStyles].join(' ');
