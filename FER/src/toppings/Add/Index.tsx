...
export const Adding = ({ handleSetStep }: { handleSetStep: (step: 'init' | 'adding' | 'checkout') => void }) => {
    ...
    const handleCheckout = async () => {
        ...
        try {
            const response: any = await saxios.post('/toppings/checkout', updates);
            if (response.data) {
    ...
    return <Flex direction="col">
        ...
        {done && (
            <Flex gap="md" direction="col">
                <Text text="Checkout done!" />
                <Flex gap="md">
                    <Button text="buy more" onClick={() => {
                        setToppings('loading');
                        handleFetchToppings();
                        setDone(false);
                    }
                    ...
                    <Link to={'/'}>
                        <Button text="back to click" onClick={() => handleSetStep('init')} />
                    </Link>
                </Flex>
            </Flex>
        )}
